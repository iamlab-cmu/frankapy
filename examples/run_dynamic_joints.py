...
from frankapy.proto_utils import make_joint_position_proto, sensor_proto2ros_msg
...
if __name__ == "__main__":
    ...
    for i in range(2, len(ts)):
        proto_msg = make_joint_position_proto(i, rospy.Time.now().to_time() - init_time, joints_traj[i])
        ros_msg = sensor_proto2ros_msg(proto_msg, SensorDataMessageType.JOINT_POSITION)
